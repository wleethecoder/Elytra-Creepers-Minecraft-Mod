...
public class NEATTest {
    ...
    private static final String AGENT_DIRECTORY_PATH = "/assets/elytracreepers/agent";
    public static final File MODEL_DIRECTORY_PATH = new File(System.getProperty("user.dir"), "src/main/resources" + AGENT_DIRECTORY_PATH);
...
//        }
    ...
    private static void saveAndLoad() {
        ...
        // saving
        File file = new File(MODEL_DIRECTORY_PATH, "agent.dat");
